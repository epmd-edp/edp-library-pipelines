...
class Job {
    ...
    def securityCheckName
    def optionsForSecurityCheck
    ...
    def initDeployJob() {
        ...
        this.rpProject = getParameterValue("REPORT_PORTAL_PROJECT")
        this.rpEndpoint = getParameterValue("REPORT_PORTAL_URL")
