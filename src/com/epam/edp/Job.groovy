...
class Job {
    ...
    def init() {
        ...
        this.triggerJobParameters = setTriggerJobParameters()
    ...
    private def setTriggerJobParameters() {
        def triggerJobParameterEnvValue = getParameterValue("TRIGGER_JOB_PARAMETER")
        if (!triggerJobParameterEnvValue)
            return

        def parsedTriggerJobParameter = new JsonSlurperClassic().parseText(getParameterValue("TRIGGER_JOB_PARAMETER"))
...
//    @NonCPS
//    def setTriggerJobParameters(parameters) {
//        for (param in parameters) {
//            script.print("param - ${param}")
//            if (param)
//                this.triggerJobParametersTest.push(script.string(name: param.name, value: param.value))
//        }
//        script.println("1.5 this.triggerJobParameters - ${this.triggerJobParameters}")
//    }
}