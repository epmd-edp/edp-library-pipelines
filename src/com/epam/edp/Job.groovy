...
class Job {
    ...
    def helmDownloadUrl = "https://get.helm.sh/helm-v3.2.4-linux-amd64.tar.gz"
    ...
    def getTokenFromAdminConsole() {
        ...
        def realmName = platform.getJsonPathValue("keycloakrealm.v1.edp.epam.com", "main", ".spec.realmName")
