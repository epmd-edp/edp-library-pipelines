...
class GitInfo {
    ...
    def init() {
        ...
        defineGitVariables(this.project, ["GERRIT_PROJECT", "GERRIT_PROJECT_NAME"])
        defineGitVariables(this.branch, ["GERRIT_BRANCH", "ghprbActualCommit"])
        defineGitVariables(this.displayBranch, ["GERRIT_BRANCH", "ghprbSourceBranch"])
    ...
    def defineGitVariables(variable, envVariablesList) {
