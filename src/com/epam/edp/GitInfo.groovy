    ...
    def init() {
        ...
        switch (job.type) {
            ...
            case [JobType.BUILD.value, JobType.CODEREVIEW.value]:
                ...
                if (!this.project || !this.branch)
                    script.error("[JENKINS][ERROR] Couldn't determine project or branch, please make sure that GERRIT_PROJECT_NAME or/and BRANCH variables are defined")
        }
