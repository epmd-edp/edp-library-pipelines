    ...
    def init() {
        ...
        switch (job.type) {
            case JobType.CODEREVIEW.value:
                this.changeNumber = defineVariable(["GERRIT_CHANGE_NUMBER", "ghprbPullId", "gitlabMergeRequestId"])
                ...
                this.changeName = this.changeNumber ? "pr-${this.changeNumber}" : "mr-${this.changeNumber}"
                break
