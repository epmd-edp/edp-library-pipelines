...
def call() {
    ...
    node("master") {
        ...
        println(context.job.triggerJobPropogate)
        println(context.job.triggerJobParameters)
        def test = context.job.setTriggerJobParameters([
        ...
        println("test - ${test}")
        context.job.triggerJobParameters = context.job.setTriggerJobParameters([
                ['name': 'PARAM', 'value': 'true'],
                ['name': 'NAME', 'value': context.codebase.config.name ],
                ['name': 'TYPE', 'value': context.codebase.config.type ],
                ['name': 'BUILD_TOOL', 'value': context.codebase.config.build_tool ],
