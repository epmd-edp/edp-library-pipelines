    ...
    node("master") {
        stage("Init") {
            ...
            if (context.codebase.config.versioningType == "edp") {
                ...
                context.codebase.setVCStag("build/${context.codebase.branchVersion}")
                context.codebase.setDStag("${context.codebase.buildVersion}")

                context.codebase.vcsTag = setVCStag("build/${context.codebase.buildVersion}")
                context.codebase.dsTag = setDStag("${context.codebase.buildVersion}")
