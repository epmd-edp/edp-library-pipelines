...
def call() {
    ...
    node("master") {
        stage("Init") {
            ...
            println("[JENKINS][DEBUG]  codebase_branch->>> - ${context.codebase.config.codebase_branch}")
            println("[JENKINS][DEBUG]  codebase_branch.version->>> - ${context.codebase.config.codebase_branch.version}")
